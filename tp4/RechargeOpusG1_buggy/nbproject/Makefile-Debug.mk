...
${OBJECTDIR}/BankCredentials.o: BankCredentials.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BankCredentials.o BankCredentials.cpp

${OBJECTDIR}/ClientAccount.o: ClientAccount.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClientAccount.o ClientAccount.cpp

${OBJECTDIR}/McisBankAccount.o: McisBankAccount.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/McisBankAccount.o McisBankAccount.cpp

${OBJECTDIR}/McisBankTC.o: McisBankTC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/McisBankTC.o McisBankTC.cpp

${OBJECTDIR}/Notifier.o: Notifier.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Notifier.o Notifier.cpp

${OBJECTDIR}/OpusControler.o: OpusControler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OpusControler.o OpusControler.cpp

${OBJECTDIR}/TransactionControler.o: TransactionControler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TransactionControler.o TransactionControler.cpp
...
${TESTDIR}/TestFiles/f5: ${TESTDIR}/tests/TestOpusController.o ${TESTDIR}/tests/runTestOpusController.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
...
${TESTDIR}/tests/TestNotifier.o: tests/TestNotifier.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++0x `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestNotifier.o tests/TestNotifier.cpp


${TESTDIR}/tests/runTestNotifier.o: tests/runTestNotifier.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++0x `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/runTestNotifier.o tests/runTestNotifier.cpp


${TESTDIR}/tests/TestClientAccount.o: tests/TestClientAccount.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++0x `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestClientAccount.o tests/TestClientAccount.cpp


${TESTDIR}/tests/runTestClientAccount.o: tests/runTestClientAccount.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++0x `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/runTestClientAccount.o tests/runTestClientAccount.cpp


${TESTDIR}/tests/TestOpusController.o: tests/TestOpusController.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++0x `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestOpusController.o tests/TestOpusController.cpp


${TESTDIR}/tests/runTestOpusController.o: tests/runTestOpusController.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++0x `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/runTestOpusController.o tests/runTestOpusController.cpp


${TESTDIR}/tests/TransactionControllerTest.o: tests/TransactionControllerTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++0x `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TransactionControllerTest.o tests/TransactionControllerTest.cpp


${TESTDIR}/tests/runTestTransactionController.o: tests/runTestTransactionController.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++0x `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/runTestTransactionController.o tests/runTestTransactionController.cpp
...
${OBJECTDIR}/BankCredentials_nomain.o: ${OBJECTDIR}/BankCredentials.o BankCredentials.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BankCredentials_nomain.o BankCredentials.cpp;\
	else  \
...
${OBJECTDIR}/ClientAccount_nomain.o: ${OBJECTDIR}/ClientAccount.o ClientAccount.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClientAccount_nomain.o ClientAccount.cpp;\
	else  \
...
${OBJECTDIR}/McisBankAccount_nomain.o: ${OBJECTDIR}/McisBankAccount.o McisBankAccount.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/McisBankAccount_nomain.o McisBankAccount.cpp;\
	else  \
...
${OBJECTDIR}/McisBankTC_nomain.o: ${OBJECTDIR}/McisBankTC.o McisBankTC.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/McisBankTC_nomain.o McisBankTC.cpp;\
	else  \
...
${OBJECTDIR}/Notifier_nomain.o: ${OBJECTDIR}/Notifier.o Notifier.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Notifier_nomain.o Notifier.cpp;\
	else  \
...
${OBJECTDIR}/OpusControler_nomain.o: ${OBJECTDIR}/OpusControler.o OpusControler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OpusControler_nomain.o OpusControler.cpp;\
	else  \
...
${OBJECTDIR}/TransactionControler_nomain.o: ${OBJECTDIR}/TransactionControler.o TransactionControler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TransactionControler_nomain.o TransactionControler.cpp;\
	else  \
