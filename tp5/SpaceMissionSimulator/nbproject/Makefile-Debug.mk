...
${OBJECTDIR}/SpaceCraft.o: SpaceCraft.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpaceCraft.o SpaceCraft.cpp

${OBJECTDIR}/SpaceObject.o: SpaceObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpaceObject.o SpaceObject.cpp

${OBJECTDIR}/SpaceObjectFactory.o: SpaceObjectFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpaceObjectFactory.o SpaceObjectFactory.cpp

${OBJECTDIR}/SpacePlanet.o: SpacePlanet.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpacePlanet.o SpacePlanet.cpp
...
${TESTDIR}/tests/RunTestControler.o: tests/RunTestControler.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RunTestControler.o tests/RunTestControler.cpp


${TESTDIR}/tests/TestControler.o: tests/TestControler.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestControler.o tests/TestControler.cpp


${TESTDIR}/tests/RunTestSandBox.o: tests/RunTestSandBox.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RunTestSandBox.o tests/RunTestSandBox.cpp


${TESTDIR}/tests/TestSandBox.o: tests/TestSandBox.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestSandBox.o tests/TestSandBox.cpp


${TESTDIR}/tests/RunTestSpaceObject.o: tests/RunTestSpaceObject.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RunTestSpaceObject.o tests/RunTestSpaceObject.cpp


${TESTDIR}/tests/TestSpaceObject.o: tests/TestSpaceObject.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestSpaceObject.o tests/TestSpaceObject.cpp


${TESTDIR}/tests/RunTestSpaceObjectFactory.o: tests/RunTestSpaceObjectFactory.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RunTestSpaceObjectFactory.o tests/RunTestSpaceObjectFactory.cpp


${TESTDIR}/tests/TestSpaceObjectFactory.o: tests/TestSpaceObjectFactory.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestSpaceObjectFactory.o tests/TestSpaceObjectFactory.cpp
...
${OBJECTDIR}/Controler_nomain.o: ${OBJECTDIR}/Controler.o Controler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Controler_nomain.o Controler.cpp;\
	else  \
...
${OBJECTDIR}/Data_nomain.o: ${OBJECTDIR}/Data.o Data.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Data_nomain.o Data.cpp;\
	else  \
...
${OBJECTDIR}/SandBox_nomain.o: ${OBJECTDIR}/SandBox.o SandBox.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SandBox_nomain.o SandBox.cpp;\
	else  \
...
${OBJECTDIR}/SpaceCraft_nomain.o: ${OBJECTDIR}/SpaceCraft.o SpaceCraft.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpaceCraft_nomain.o SpaceCraft.cpp;\
	else  \
...
${OBJECTDIR}/SpaceObject_nomain.o: ${OBJECTDIR}/SpaceObject.o SpaceObject.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpaceObject_nomain.o SpaceObject.cpp;\
	else  \
...
${OBJECTDIR}/SpaceObjectFactory_nomain.o: ${OBJECTDIR}/SpaceObjectFactory.o SpaceObjectFactory.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpaceObjectFactory_nomain.o SpaceObjectFactory.cpp;\
	else  \
...
${OBJECTDIR}/SpacePlanet_nomain.o: ${OBJECTDIR}/SpacePlanet.o SpacePlanet.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpacePlanet_nomain.o SpacePlanet.cpp;\
	else  \
